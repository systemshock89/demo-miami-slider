...
function slider() {
  const sliderMain = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider_main', {
    freeMode: true,
    // позволяет листать слайды без привязки к позиции слайда
    centeredSlides: true,
    // 1-й слайд будет в центре
    mousewheel: true,
    parallax: true,
    breakpoints: {
      0: {
        // ширина экрана от 0 до 680
        slidesPerView: 2.5,
        // показывать 2,5 слайда
        spaceBetween: 20 // расстояние между слайдами
      },

      680: {
        // от 680 до бесконечности
        slidesPerView: 3.5,
        spaceBetween: 60
      }
    },
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["FreeMode"], swiper__WEBPACK_IMPORTED_MODULE_0__["Mousewheel"], swiper__WEBPACK_IMPORTED_MODULE_0__["Parallax"], swiper__WEBPACK_IMPORTED_MODULE_0__["Controller"]]
  });

  // слайдер с размытием фона
  const sliderBg = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider_bg', {
    centeredSlides: true,
    parallax: true,
    slidesPerView: 3.5,
    spaceBetween: 60,
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["Parallax"], swiper__WEBPACK_IMPORTED_MODULE_0__["Controller"]]
  });
